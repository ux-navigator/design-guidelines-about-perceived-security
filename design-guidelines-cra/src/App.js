    ...
    <header className="nav" id="header">
      ...
      <div className="gnb_wrap">
        <nav id="gnb" className="gnb hover_color">
          <ul className="dep1">
            <li><a className="btn" onClick={handleDesignGuidelineClick}>Design Guidelines</a></li>
...
const Part_2 = (props) => {
  function handleDetailGuidelineClick() {
    console.log("버튼 눌렀음");
    window.location.href = "gudielines.html"
  }
  function handleDetailGuidelineMouseOver() {
    console.log("버튼 마우스 오버");
  }
  return (
    <div id="part_02">
      <div id="part_02_wrap">
        ...
        <button onClick={handleDetailGuidelineClick} onMouseOver={handleDetailGuidelineMouseOver} className="btn1">자세히 보기
  ...
  return (
    <footer className="footer">
      <div>
        ...
        <div className="gray_1 btn" >CONTACT</div>
      </div>
    </footer>
  );
}
    ...
    <div>
      ...
      <main className="container" id="container">
        <div className="content" id="content1">
          ...
          <About />
          <Part_1 />
          <Mockup_1 img="./img/mockup01.png" />
          <Part_2 img="./img/part_02_img.png" />
          <Part_3 img="./img/part_03_img.png" />
        </div>

      </main>
      <Part_4 img="./img/development process.png" />
      <main>
