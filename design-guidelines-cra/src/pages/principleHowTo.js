            ...
            <div className='PrincipleHowTo' >
                ...
                <div>
                    <ul className='HowToList' >
                        <div onClick={onContactClick1} id="1"><li className='body_2 blue_C btn'>{props.li1}</li></div>
                        <div onClick={onContactClick2} id="2"><li className='body_2 blue_C btn'>{props.li2}</li></div>
                        <div onClick={onContactClick3} id="3"><li className='body_2 blue_C btn'>{props.li3}</li></div>
                        <div onClick={onContactClick4} id="4"><li className='body_2 blue_C btn'>{props.li4}</li></div>
                        <div onClick={onContactClick5} id="5"><li className='body_2 blue_C btn'>{props.li5}</li></div>
                        <div onClick={onContactClick6} id="1"><li className='body_2 blue_C btn'>{props.li6}</li></div>
                    </ul>
                </div>
