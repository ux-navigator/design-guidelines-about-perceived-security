...
const SideNav = () => {
    return (
        <nav className='SideNav'>
            <ul>
                <li className='body_3 nav_li'>Coherence</li>
                <li className='body_3 gray_2 nav_li'>Controllability</li>
                <li className='body_3 gray_2 nav_li'>Predictability</li>
                <li className='body_3 gray_2 nav_li'>Information Conveying</li>
                <li className='body_3 gray_2 nav_li'>Minimum Collecting</li>
                <li className='body_3 gray_2 nav_li'>Social Proof</li>
                <li className='body_3 gray_2 nav_li'>Error Handling</li>
            </ul>
