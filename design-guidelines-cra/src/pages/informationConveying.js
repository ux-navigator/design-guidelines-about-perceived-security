    ...
    return (
        <nav className='SideNav'>
            <ul>
                ...
                <Link to="/informationConveying"><li className='body_3 black bold nav_li'>Information Conveying</li></Link>
...
const PrincipleTitle = () => {
    return (
        <div className='PrincipleTitle'>
            <h2 className='title_3'>Information Conveying</h2>
            <p className='body_2 gray_1 PrincipleTitle_de'>정보 전달성(Information Conveying)은 사용자 입장에서 필요한 정보를 쉽게 인지하고 이해할 수 있게 제공함으로써 사용자가 느낄 수 있는 의문사항을 해소하고 친절함을 느끼게 하여 신뢰도를 높이는 방법입니다.</p>
        </div>
...
const PrincipleWhy = () => {
    return (
        <div className='PrincipleWhy'>
            <h2 className='title_4 mb_20'>Why is &#34;Information Conveying&#34; necessary?</h2>
